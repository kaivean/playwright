...
try {
    const installBrowsersForNpmInstall = require('playwright-core/lib/server').installBrowsersForNpmInstall;
    installBrowsersForNpmInstall(['chromium', 'ffmpeg', 'firefox', 'webkit'])
} catch (e) {
